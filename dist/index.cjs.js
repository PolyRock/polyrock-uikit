...
var Icon$I = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" }, props),
        React__default['default'].createElement("path", { d: "m288.956 18.541-76.798 56.97 76.619 18.361z" }),
        React__default['default'].createElement("path", { d: "m429.366 245.519-27.109-129.687-44.455 90.537z" }),
        React__default['default'].createElement("path", { d: "m282.96 102.761-81.947-19.638-83.744 35.52 65.555 68.348z" }),
        React__default['default'].createElement("path", { d: "m183.426 275.08 160.76-69.073-51.942-97.953-104.902 88.221z" }),
        React__default['default'].createElement("path", { d: "m185.982 284.866 45.062 57.394 180.541 45.379-63.284-172.517z" }),
        React__default['default'].createElement("path", { d: "m223.099 348.334-46.511-59.241-95.136 46.029 30.563 110.414 107.744-12.44z" }),
        React__default['default'].createElement("path", { d: "m229.735 433.904 135.255 40.869 46.746-76.785-178.815-44.945z" }),
        React__default['default'].createElement("path", { d: "m417.074 373.564 14.033-115.693-70.651-38.651z" }),
        React__default['default'].createElement("path", { d: "m125.58 454.036 78.728 39.423 138.022-15.086-118.198-35.716z" }),
        React__default['default'].createElement("path", { d: "m397.956 101.9-99.002-82.645-.189 79.715 52.241 98.483z" }),
        React__default['default'].createElement("path", { d: "m177.355 195.745-65.311-68.1-30.136 196.148 91.28-44.164zm-54.043-6.814-11.112 66.928a5 5 0 1 1 -9.865-1.638l11.11-66.928a5 5 0 0 1 9.865 1.638zm3.77-22.708-.6 3.6a5 5 0 1 1 -9.865-1.639l.6-3.6a5 5 0 0 1 9.865 1.639z" })));
};
...
var Icon$17 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 512 512" }, props),
        React__default['default'].createElement("g", { xmlns: "http://www.w3.org/2000/svg" },
            React__default['default'].createElement("path", { d: "m200.34 298.8h128.65l44.25-93.05.002-.004 41.415 23.474c3.78 2.15 6.51 5.64 7.67 9.83 1.16 4.2.61 8.59-1.53 12.37-4.09 7.21-1.56 16.37 5.65 20.45 2.34 1.33 4.88 1.95 7.38 1.95 5.23 0 10.3-2.73 13.07-7.6 6.09-10.76 7.64-23.25 4.34-35.16-3.29-11.92-11.03-21.84-21.79-27.94l-42.377-24.02-120.673-68.4c-10.76-6.09-23.24-7.64-35.16-4.34-11.92 3.29-21.84 11.03-27.93 21.79-4.09 7.2-1.56 16.36 5.65 20.44 7.2 4.09 16.36 1.56 20.44-5.65 2.15-3.79 5.64-6.51 9.83-7.67 4.2-1.16 8.59-.61 12.38 1.53l41.263 23.39z" }),
            React__default['default'].createElement("path", { d: "m401.86 153 57.27-101.02c4.11-6.93 1.44-16.6-5.65-20.44l-52.2-29.59c-7.21-4.08-16.36-1.55-20.45 5.65l-57.26 101.02z" }),
            React__default['default'].createElement("path", { d: "m497 387h-31.44l-41.32-30.48c-4.24-3.13-9.82-3.8-14.69-1.77l-5.74 2.4 30.88 71.14c2.47 5.69 3.72 11.72 3.72 17.92v65.79h58.59c8.28 0 15-6.72 15-15v-95c0-8.28-6.72-15-15-15z" }),
            React__default['default'].createElement("path", { d: "m102.45 354.75c-4.87-2.03-10.45-1.36-14.69 1.77l-41.32 30.48h-31.44c-8.28 0-15 6.72-15 15v95c0 8.28 6.72 15 15 15h58.59v-65.79c0-6.2 1.25-12.23 3.72-17.93l30.88-71.13z" }),
            React__default['default'].createElement("path", { d: "m362.71 337.83c-2.38-5.48-7.79-9.03-13.76-9.03h-185.9c-5.97 0-11.38 3.55-13.76 9.03l-44.46 102.4c-.82 1.89-1.24 3.92-1.24 5.98v65.79h304.82v-65.79c0-2.06-.42-4.09-1.24-5.98z" }))));
};
...
var socials = [
    {
        ...
        items: [
            {
                label: "English",
                href: "https://t.me/PolyrockPolygon",
            },
        ],
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/ThePolyRock",
    },
];
var MENU_HEIGHT = 64;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#000000", textDisabled: "#BDC2C4", textSubtle: "#0e0e2c66", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#000000", textDisabled: "#666171", textSubtle: "#0e0e2c66", borderColor: "#524B63", card: "#27262c", gradients: {
